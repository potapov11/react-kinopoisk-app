...
export const MovieDataContext = ({ children }) => {
	...
	useEffect(() => {
		const fetchData = async () => {
			try {
				const popularResponse = await fetch(API_url_popular, headers);
				...
				const newsResponse = await fetch(API_NEWS, headers);
	...
	function searchMovie(value) {
		...
		fetch(value ? apiSearcUrl : API_url_popular, headers)
